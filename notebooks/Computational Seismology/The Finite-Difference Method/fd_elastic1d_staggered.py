...
#
# Then, improve the result using higher order approximation (4 point operator) for 1st derivative.
#
...
for it in range(nt):
    t = (it - t0) * dt
    tmp[it] = -2 * a * t * np.exp(-(a * t) ** 2)       # derivative of a Gaussian 
...
line1 = ax1.plot(x, v, 'k', lw = 1.5)
line2 = ax2.plot(x, s, 'r', lw = 1.5)
